...
if __name__ == "__main__":
    ...
    for npy_dir in dir_list:
        if npy_dir == "npy_train_1" or npy_dir == "npy_train_3" or npy_dir == "npy_train_4" or npy_dir == "npy_test_1" or npy_dir == "npy_test_3" or npy_dir == "npy_test_4":
    ...
    np.save(os.path.join(dataset_path, "bottle0_train.npy"), bottle0_train)
    np.save(os.path.join(dataset_path, "bottle0_test.npy"), bottle0_test)
