...
assert fixed_length == 1, "check fixed length"
...
def read_talk_noise(path, array_list):
    ...
    for file in file_list:
        ...
        talk_resample = librosa.core.resample(talk, orig_sr=talk_sr, target_sr=16000)
...
def audio_process(audio, orig_sr, target_frequency_, vis, fig_name):
    ...
    if add_noise:
        choice_list = [1,11,2,3,4,5] 
        choice = np.random.choice(choice_list, 1)
        if choice == 1 or choice == 11: # no change
